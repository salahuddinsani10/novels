        ...
        <div className="flex flex-col md:flex-row h-auto md:h-[650px]">
          ...
          <div className="w-full md:w-7/12 p-6 overflow-y-auto">
            ...
            <form onSubmit={handleSignup} className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="relative group col-span-2">
                  ...
                  <div className="h-5 mt-1">
                    ...
                    {touched.password && passwordValid && (
                      <span className={`text-xs ${passwordStrength === 'Strong' ? 'text-green-500' : 'text-yellow-600'} animate-fade-in`}>{passwordStrength}</span>
                    )}
                  </div>
                </div>
              ...
              <button
                type="submit"
                className="w-full py-3 text-sm rounded-xl bg-yellow-500 text-white hover:bg-yellow-600 transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl disabled:bg-gray-300 disabled:cursor-not-allowed disabled:transform-none mt-2"
                disabled={
                  !formData.role ||
                  !formData.name ||
                  !formData.email ||
